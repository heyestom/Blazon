...
<html>
<head>
<link rel="stylesheet" type="text/css" href="blazonstyle.css">
...
{ 
  ...
  // all the tinctures
  var tinctures = new Array(new tincture("azure","blue",false,"#000077"),new tincture("gules","red",false,"#FF0000"), new tincture("sable","black",false,"#000000"), new tincture("purpure","purple",false,"#990099"),new tincture("vert","green",false,"#339933"), new tincture("or","gold/yellow",true,"#FFCC00"),new tincture("argent","silver/white",true,"#E8E8E8"));
...
<h1> 
<h1>Blazon online Beta (THIS MEANS THINGS WONT WORK ALL THE TIME! :D).</h1>

<p id="demo">Blazon to be parsed:</p>

<button type="button" onclick="blazon()">BLAZE!</button>
<input id="input_string" type="text" size="100" name="input_string" onkeydown="if (event.keyCode == 13) blazon()"  > 
<p id="input">input</p>
